...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::to('/')}}/front/styles/courses.css">
    <link rel="stylesheet" type="text/css" href="{{URL::to('/')}}/front/styles/courses_responsive.css">
</head>
<body>
                        ...
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            ...
                            <nav class="main_nav_contaner ml-auto">
                                <ul class="main_nav">
                                    ...
                                    <li class="active"><a href="{{url('/abimbel')}}">Bimbel</a></li>
                ...
                <div class="col-lg-12">
                    <div class="courses_search_container">
                        <form action="#" id="courses_search_form" class="courses_search_form d-flex flex-row align-items-center justify-content-start">
                            <input type="search" class="courses_search_input" placeholder="Cari Bimbel" required="required">
...
<script src="{{URL::to('/')}}/front/js/courses.js"></script>
</body>
</html>