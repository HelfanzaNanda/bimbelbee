                        ...
                        <div class="col">
                            <div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
                                ...
                                <div class="top_bar_login ml-auto">
                                    <div class="login_button"><a href="{{route('bimbel.login')}}">Login</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row team_row">
                ...
                <div class="col-lg-6 team_col">
                    <div class="team_item">
                        ...
                        <div class="team_body">
                            <div class="team_title"><a href="#">Login Sebagai Siswa</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 team_col">
                    <div class="team_item">
                        ...
                        <div class="team_body">
                            <div class="team_title"><a href="{{ route('bimbel.login') }}">Login Sebagai Bimbel</a></div>
