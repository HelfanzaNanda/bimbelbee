            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        <form id="form1" action="{{route('usiswa.update', $usiswa->id)}}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{method_field('PATCH')}}
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" required="required" name="name"
                                           ...
                                           placeholder="Masukkan Nama Bimbel" value="{{$usiswa->name}}">
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required="required" name="email" disabled
                                           ...
                                           placeholder="Masukkan Email Bimbel" value="{{$usiswa->email}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" value="{{$usiswa->avatar}}" name="old_avatar">
                                ...
                                <div class="box-footer form-group">
                                    ...
                                    <a href="{{route('usiswa')}}" class="btn btn-warning">Kembali</a>
                                </div>
                            </div>
