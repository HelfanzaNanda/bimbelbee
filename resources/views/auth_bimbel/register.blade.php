...
<div class="register-box">
    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form action="{{route('bimbel.register.submit')}}" method="post" enctype="multipart/form-data">
                @csrf
            ...
            <a href="{{route('bimbel.login')}}" class="text-center">I already have a membership</a>
        </div>
        <!-- /.form-box -->
    </div><!-- /.card -->
</div>
